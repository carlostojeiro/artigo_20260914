...
TON\_IoT & MLP & \emph{pending} & \emph{pending} & \emph{--} & \emph{pending} & \emph{pending} & \emph{pending} \\
TON\_IoT & XGBoost & \emph{pending} & \emph{pending} & \emph{--} & \emph{pending} & \emph{pending} & \emph{pending} \\
TON\_IoT & R. Forest & \emph{pending} & \emph{pending} & \emph{--} & \emph{pending} & \emph{pending} & \emph{pending} \\
TON\_IoT & LSTM & \emph{pending} & \emph{pending} & \emph{--} & \emph{pending} & \emph{pending} & \emph{pending} \\
...
inserted, and no value is invented): the Edge-IIoTset round is complete,
and TON\_IoT and IoT-23 remain \emph{pending} their {\tt [OOF-10]} runs.

\begin{table}[!t]
\centering
\caption{Out-of-fold robustness (mean\,$\pm$\,std over 10 folds; FN is the
security-critical total). Values reported verbatim from
{\tt resultados\_oof10\_<dataset>.csv} (Edge-IIoTset concluded;
TON\_IoT and IoT-23 \emph{pending} the remaining {\tt [OOF-10]} runs).}
\label{tab:robust}
\footnotesize
...
TON\_IoT & \emph{pending} & \emph{pending} & \emph{pending} & \emph{pending} \\
